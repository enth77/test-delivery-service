            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="deliveries"
                        to="/deliveryManagers/deliveries"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문', 
                description: '고객이 음식 주문을 생성하는 주문 객체', 
                key: 'orders', 
            ...
            { 
                title: '배달 작업', 
                description: '배달원이 수행하는 배달 작업 객체', 
                key: 'deliveryJobs', 
                route: '/deliveries/deliveryJobs',
                ImageUrl: '',
            },
            { 
                title: '음식점', 
                description: '사업자가 소유하는 음식점 객체', 
                key: 'restaurants', 
                route: '/businessOwners/restaurants',
                ImageUrl: '',
            },
            { 
                title: '배달', 
                description: '배달 내역을 관리하는 객체', 
                key: 'deliveries', 
                route: '/deliveryManagers/deliveries',
                ImageUrl: '',
            },
